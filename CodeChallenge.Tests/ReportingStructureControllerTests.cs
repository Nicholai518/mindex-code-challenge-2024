...
namespace CodeChallenge.Tests.Integration
{
    ...
    public class ReportingStructureControllerTests
    {
        ...
        [TestMethod]
        public void GetJohnLennonReportingStructureById_Returns_Ok()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetPaulMcCartneyReportingStructureById_Returns_Ok()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetReportingStructureInvalidId_Returns_NotFound()
        {
            // Arrange
